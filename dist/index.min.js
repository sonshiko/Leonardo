function initMoveButtons(){[{dataId:"Up",direction:"up"},{dataId:"Left",direction:"left"},{dataId:"Bottom",direction:"bottom"},{dataId:"Right",direction:"right"},{dataId:"Mirror",direction:"mirror"},{dataId:"Rotate90",direction:"rotate90"},{dataId:"Rotate-90",direction:"rotate-90"},{dataId:"Rotate1",direction:"rotate1"},{dataId:"Rotate-1",direction:"rotate-1"}].forEach(a=>{const t=document.querySelectorAll("[data-id="+a.dataId+"]");t.forEach(function(t){t.addEventListener("click",function(){moveCanvas(a.direction,t.getAttribute("data-target"))})})})}const plagiart={init(t){window.onload=plagiart.main(t)},main(t){renderHtml(t),initMoveButtons(),switchSidebar(),initTranslate(),this.canvasOrig=document.getElementById("original-image"),this.canvasCopy=document.getElementById("copy-image"),this.canvasHeight=this.canvasOrig.parentElement.clientHeight,this.canvasWidth=this.canvasOrig.parentElement.clientWidth,this.canvasOrig.width=this.canvasWidth,this.canvasOrig.height=this.canvasHeight,this.canvasCopy.width=this.canvasWidth,this.canvasCopy.height=this.canvasHeight,this.inputHeight=document.getElementById("canvasHeight"),this.inputWidth=document.getElementById("canvasWidth");let a=this.canvasOrig.getContext("2d"),e=this.canvasCopy.getContext("2d"),i=new Image;i.onload=function(){plagiart.resizeCanvasToImg(plagiart.canvasOrig,i),plagiart.origImgHeight=i.height,plagiart.origImgWidth=i.width,plagiart.inputHeight.removeAttribute("disabled"),plagiart.inputHeight.value=0,plagiart.inputWidth.removeAttribute("disabled"),plagiart.inputWidth.value=0,a.drawImage(i,0,0)};let n=new Image;n.onload=function(){plagiart.resizeCanvasToImg(plagiart.canvasCopy,n),e.drawImage(n,0,0)},uploadPicture("original",i),uploadPicture("clone",n),this.changeOpacity(this.canvasCopy),this.changeScale(this.canvasCopy,document.getElementById("scaleCopy")),this.changeScale(this.canvasOrig,document.getElementById("scaleOrig")),this.inputHeight.addEventListener("keyup",function(){plagiart.inputWidth.value=this.value*plagiart.origImgWidth/plagiart.origImgHeight}),this.inputWidth.addEventListener("keyup",function(){plagiart.inputHeight.value=this.value*plagiart.origImgHeight/plagiart.origImgWidth}),this.canvasOrig.addEventListener("mousemove",function(t){const a=t.target;var e=a.getBoundingClientRect(),i={x:t.clientX-e.x,y:t.clientY-e.y},t={width:e.width,heigth:e.height},e={width:0===plagiart.inputWidth.value?e.width:plagiart.inputWidth.value,height:0===plagiart.inputHeight.value?e.height:plagiart.inputHeight.value},t={x:Math.round(e.width*i.x/t.width),y:Math.round(e.height*i.y/t.heigth)};document.getElementById("remappedX").innerText=t.x,document.getElementById("remappedY").innerText=t.y}),this.mode="scale";const l=document.getElementById("plagiartWrapper");l.classList.add("scale-mode"),this.modeInputs=document.getElementsByClassName("mode");for(let t=0;t<this.modeInputs.length;t++)this.modeInputs[t].addEventListener("change",function(t){"scale"===plagiart.mode?(plagiart.mode="compare",l.classList.remove("scale-mode"),l.classList.add("compare-mode")):(plagiart.mode="scale",l.classList.remove("compare-mode"),l.classList.add("scale-mode"))})},changeOpacity(a){const t=document.getElementById("transparency");t.value=50,a.style.opacity=1-t.value/100,t.addEventListener("input",function(t){t=t.target.value;a.style.opacity=1-t/100})},changeScale(a,t){t.value=100,a.style.transform=`scale(${t.value/100})`,t.addEventListener("input",function(t){t=t.target.value;a.style.transform=`scale(${t/100})`})},resizeCanvasToImg(t,a){const e=t.getContext("2d");e.fillStyle="white",e.fillRect(0,0,t.height,t.width),t.width=a.width,t.height=a.height}};function showModal(t){const a=document.getElementById(t);a.classList.add("visible");const e=document.getElementById("plagiartWrapper");e.classList.add("blur");const i=document.getElementById("reload");i.addEventListener("click",function(){window.location.reload()})}function moveCanvas(t,a){let c=document.getElementById("original-wrapper");"copy"===a&&(c=document.getElementById("copy-wrapper"));switch(t){case"up":e(-2,"data-vertical");break;case"left":e(-2,"data-horizontal");break;case"bottom":e(2,"data-vertical");break;case"right":e(2,"data-horizontal");break;case"mirror":e(2,"mirror");break;case"rotate90":e(2,"rotate90");break;case"rotate1":e(2,"rotate1");break;case"rotate-90":e(2,"rotate-90");break;case"rotate-1":e(2,"rotate-1")}function e(t,a){let e=null===c.getAttribute("data-vertical")?0:parseInt(c.getAttribute("data-vertical")),i=null===c.getAttribute("data-horizontal")?0:parseInt(c.getAttribute("data-horizontal")),n=null===c.getAttribute("data-mirror")?0:parseInt(c.getAttribute("data-mirror")),l=null===c.getAttribute("data-rotate")?0:parseInt(c.getAttribute("data-rotate"));var s=0===n?1:-1;switch(a){case"data-horizontal":i+=t,c.setAttribute("data-horizontal",i);break;case"data-vertical":e+=t,c.setAttribute("data-vertical",e);break;case"mirror":n=180===n?0:180,c.setAttribute("data-mirror",n);break;case"rotate90":l+=90*s,c.setAttribute("data-rotate",l);break;case"rotate1":l+=s,c.setAttribute("data-rotate",l);break;case"rotate-90":l-=90*s,c.setAttribute("data-rotate",l);break;case"rotate-1":l-=s,c.setAttribute("data-rotate",l)}var r="translateY("+e+"px)",o="translateX("+i+"px)",d="rotateY("+n+"deg)",a="rotate("+l+"deg)";c.style.transform=o+" "+r+" "+d+" "+a}}function renderHtml(t){t=document.getElementById(t);createElement("header",`
			<!-- Begin of header -->
			<!-- svg sprite -->
			<svg display="none">
    ...
    `,t,["main"]),createElement("footer",`
		...
		<!-- End of footer -->
		`,t,["footer"]),createElement("div",`
        <h3>Something is went wrong. Click "OK" to reload page.</h3>
        <button class="btn" id="reload">Ok</button>`,void 0,["modal"],"modal")}function createElement(t,a,e,i,n){const l=document.createElement(t);l.innerHTML=a,(e||document.body).append(l),void 0!==i&&i.forEach(t=>{l.classList.add(t)}),void 0!==n&&l.setAttribute("id",n)}function switchSidebar(){let t=document.getElementById("sidebar-position"),a="right",e=document.getElementById("main-container");t.addEventListener("click",function(){"right"===a?(a="left",document.getElementById("sidebar-position").classList.remove("right"),document.getElementById("sidebar-position").classList.add("left")):(a="right",document.getElementById("sidebar-position").classList.remove("left"),document.getElementById("sidebar-position").classList.add("right")),e.classList.toggle("wrapper-reverse")})}function initTranslate(){var t=new XMLHttpRequest;t.open("GET","./src/transliterate.json",!0),t.responseType="json",t.onload=function(){setLanguagesAndStart(t.status,t.response)},t.send()}function setLanguagesAndStart(t,a){let i={},n="uk";function e(){const e=i,t=document.querySelectorAll("[data-translate]");t.forEach(t=>{var a=t.getAttribute("data-translate");t.innerHTML=e[a][n]});const a=document.querySelectorAll("[data-title-translate]");a.forEach(t=>{var a=t.getAttribute("data-title-translate");t.setAttribute("title",e[a][n])})}200===t?(i=a,function(){const a=document.getElementsByClassName("language");for(let t=0;t<a.length;t++)a[t].addEventListener("change",function(t){console.log("change"),n="uk"===n?"en":"uk",e()})}(),e()):showModal("modal")}function uploadPicture(t,a){let e=document.getElementById(t);e.addEventListener("change",function(){this.files&&this.files[0]&&readFile(t,a,this.files[0])})}function readFile(t,a,e){var i=new FileReader;i.addEventListener("load",function(t){a.src=t.target.result}),i.readAsDataURL(e)}plagiart.init("plagiartWrapper");